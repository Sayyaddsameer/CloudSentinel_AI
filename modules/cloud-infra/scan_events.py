# scan_events.py — cloud-infra module marker (DO NOT add executable code here)
#
...
#
# DO NOT place any import or executable code in this file; doing so will
# cause a circular ImportError when Python's import system tries to load it
# before shared/scan_events.py is fully initialised.
